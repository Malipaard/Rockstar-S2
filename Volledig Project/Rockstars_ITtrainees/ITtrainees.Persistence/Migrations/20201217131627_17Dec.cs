    ...
    public partial class _17Dec : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Articles",
                columns: new[] { "ArticleId", "Author", "Content", "HeaderImage", "Summary", "Tag", "Title" },
                values: new object[] { 1, "Sem", "Encoded PDF", "Encoded Image", "Description of the article", "Tag", "First Article" });
        }
